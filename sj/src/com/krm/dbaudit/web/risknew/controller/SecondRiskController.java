 ...
 *
 */
@Controller("secondRiskControllerNew")
@RequestMapping("secondnew/risk")
public class SecondRiskController
{
	...
	{
		List<Map<String,Object>> list = secondRiskServiceNew.findResultByMonth(params);
	...
	public void findResultByDay(@RequestParam Map<String, Object> params,
			HttpServletResponse response) 
	{
		List<Map<String,Object>> list = secondRiskServiceNew.findResultByDay(params);
		for (Map<String, Object> map : list)
		{
			map.put("flag", 0);
		}
	...
	public void findDetails(@RequestParam Map<String, Object> params,
			HttpServletResponse response) 
	{
		List<Map<String,Object>> list = secondRiskServiceNew.findDetails(params);
		ResponseUtils.renderJson(response, list);
	}
	...
	public List<File> generateFile(Map<String, Object> params,HttpServletRequest request,HttpServletResponse response){
		...
		for (String custNo : keyset)
		{
			...
			List<Map<String,Object>> list = secondRiskServiceNew.findDetails(map);
