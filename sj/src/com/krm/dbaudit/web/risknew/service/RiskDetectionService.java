...
import com.krm.dbaudit.web.risknew.mapper.RiskDetectionMapper;
...
@Service("riskDetectionServiceNew")
public class RiskDetectionService extends ServiceMybatis<RiskModelBase> 
{
	@Resource
	private RiskDetectionMapper riskDetectionMapperNew;
	...
	public PageInfo<RiskModelBase> findPageInfoByAudit(Map<String, Object> params)
	{
		...
		List<RiskModelBase> list = riskDetectionMapperNew.findPageInfoByAudit(params);
	...
	{
		PageHelper.startPage(params);
		List<RiskModelBase> list = riskDetectionMapperNew.findPageInfo(params);
		Map<String,String> temp = new HashMap<String, String>();
		for (RiskModelBase riskModelBase : list)
		{
			String sql = "select m.MODEL_ID,M.DEAL_STATUS from MODEL_DATA m where MODEL_ID = "+riskModelBase.getId()
	...
	{
		return riskDetectionMapperNew.findById(id);
	}
	...
	public List<Map<String,Object>> findLastMonthByStatus(Map<String, Object> params){
		return riskDetectionMapperNew.findLastMonthByStatus(params);
	}
	...
	public List<Map<String,Object>> findYesterdayByStatus(Map<String, Object> params){
		return riskDetectionMapperNew.findYesterdayByStatus(params);
	}
	...
	public List<Map<String,Object>> countByBar(Map<String, Object> params){
		return riskDetectionMapperNew.countByBar(params);
	}
	...
	public List<Map<String,Object>> findLastMonthByOrgan(Map<String, Object> params){
		return riskDetectionMapperNew.findLastMonthByOrgan(params);
	}
	...
	public List<Map<String,Object>> findYesterdayByOrgan(Map<String, Object> params){
		return riskDetectionMapperNew.findYesterdayByOrgan(params);
	}
	...
	public List<Map<String, Object>> findRunAmount(Map<String, Object> params)
	{
		...
		if(flag == 1){
			list = riskDetectionMapperNew.findLastRunByMonth(params);
		}else if (flag == 0){
			list = riskDetectionMapperNew.findLastRunByYesterday(params);
		}
		return list;
	}
	...
	public ModelData findModelDataByPkid(Integer id){
		return riskDetectionMapperNew.findModelDataByPkid(id);
	}

	public List<AuditModel> findAllAuditModel()
	{
		return riskDetectionMapperNew.findAllAuditModel();
	}
