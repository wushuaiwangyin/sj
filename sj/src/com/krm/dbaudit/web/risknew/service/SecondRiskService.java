...
import com.krm.dbaudit.web.risknew.mapper.SecondRiskModelMapper;

@Service("secondRiskServiceNew")
public class SecondRiskService
{
	@Resource
	private SecondRiskModelMapper secondRiskModelMapperNew;
	...
	public List<Map<String, Object>> findResultByMonth(Map<String, Object> params){
		return secondRiskModelMapperNew.findResultByMonth(params);
	}
	
	public List<Map<String, Object>> findResultByDay(Map<String, Object> params){
		return secondRiskModelMapperNew.findResultByDay(params);
	}
	
	public List<Map<String, Object>> findDetails(Map<String, Object> params){
		return secondRiskModelMapperNew.findDetails(params);
	}
	...
	public int save(List<Map<String, Object>> list){
		return secondRiskModelMapperNew.save(list);
	}
